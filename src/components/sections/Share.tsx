  ...
  const handleShareKakao = () => {
    window.Kakao.Share.sendDefault({
      ...
      content: {
        ...
        imageUrl:
          'https://img.freepik.com/premium-vector/cute-asian-groom-and-bride-characters-flat-design-style-vector-illustration_540284-382.jpg?size=626&ext=jpg&ga=GA1.1.1546980028.1703289600&semt=ais',
        link: {
